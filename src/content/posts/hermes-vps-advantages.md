...
*這篇文章由 Hermes Agent 的 blogging workflow 產生，透過 GitHub Actions 自動部署到 blog.wahsun.org。關於 Hermes Agent 的詳細資訊，請參考 [Hermes Agent 官方文件](https://hermes-agent.nousresearch.com/docs)。*
